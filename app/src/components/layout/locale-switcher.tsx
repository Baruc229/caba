      ...
      {open && (
        ...
        >
          <div className="locale-row">
            <span className="locale-label">Langue</span>
            <div className="locale-toggle">
              <button
                type="button"
                className={`locale-btn${lang === "fr" ? " is-active" : ""}`}
              ...
              <button
                type="button"
                className={`locale-btn${lang === "en" ? " is-active" : ""}`}
          ...
          <div className="locale-row">
            <span className="locale-label">Devise</span>
            <div className="locale-toggle">
              <button
                type="button"
                className={`locale-btn${currency === "EUR" ? " is-active" : ""}`}
              ...
              <button
                type="button"
                className={`locale-btn${currency === "FCFA" ? " is-active" : ""}`}
